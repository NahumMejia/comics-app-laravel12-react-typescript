...
import { BookOpen, Folder, LayoutGrid, LogIn, Menu, Search, UserPlus } from 'lucide-react';
                ...
                {rightNavItems.map((item) => (
                    ...
                    <Tooltip>
                        ...
                        >
                            ...
                            {item.icon && <Icon iconNode={item.icon} className="opacity-80 group-hover:opacity-100 w-4 sm:w-5 h-4 sm:h-5" />}
                        </a>
                        </TooltipTrigger>
                        <TooltipContent>
                        <p>{item.title}</p>
